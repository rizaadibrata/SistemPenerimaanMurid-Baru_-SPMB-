    ...
    @if(request()->is('keuangan*'))
        ...
        <li class="nav-item {{ request()->routeIs('keuangan.verifikasi') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('keuangan.verifikasi') }}">
                <i class="fas fa-fw fa-search text-success"></i>
        ...
        <li class="nav-item {{ request()->routeIs('keuangan.rekap') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('keuangan.rekap') }}">
                <i class="fas fa-fw fa-chart-bar text-info"></i>
    ...
    @elseif(request()->is('verifikator*'))
        ...
        <li class="nav-item {{ request()->routeIs('verifikator.verifikasi') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('verifikator.verifikasi') }}">
                <i class="fas fa-fw fa-file-check text-success"></i>
    ...
    @elseif(request()->is('kepsek*'))
        ...
        <li class="nav-item {{ request()->routeIs('kepsek.asal-sekolah') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('kepsek.asal-sekolah') }}">
                <i class="fas fa-fw fa-school text-warning"></i>
        ...
        <li class="nav-item {{ request()->routeIs('kepsek.asal-wilayah') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('kepsek.asal-wilayah') }}">
                <i class="fas fa-fw fa-map-marker-alt text-danger"></i>
    ...
    @else
        ...
        <li class="nav-item {{ request()->routeIs('admin.gelombang.*') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.gelombang.index') }}">
                <i class="fas fa-fw fa-calendar-alt text-info"></i>
                <span>Gelombang</span>
            </a>
        </li>
        ...
        <!-- Heading -->
        <div class="sidebar-heading text-uppercase">Riwayat</div>

        <!-- Nav Item - Riwayat Login Administrator -->
        <li class="nav-item {{ request()->routeIs('admin.log-aktivitas.admin-login') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.log-aktivitas.admin-login') }}">
                <i class="fas fa-fw fa-user-shield text-warning"></i>
                <span>Riwayat Login Administrator</span>
            </a>
        </li>

        <!-- Nav Item - Riwayat Login User -->
        <li class="nav-item {{ request()->routeIs('admin.log-aktivitas.user-login') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.log-aktivitas.user-login') }}">
                <i class="fas fa-fw fa-user text-info"></i>
                <span>Riwayat Login User</span>
            </a>
        </li>
    @endif
