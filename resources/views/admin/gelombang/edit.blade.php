...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="mb-0 text-gray-600">Ubah data gelombang pendaftaran</p>
    </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Edit Gelombang</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.gelombang.update', $gelombang) }}" method="POST">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror" 
                               ...
                               value="{{ old('tanggal_mulai', $gelombang->tanggal_mulai->format('Y-m-d')) }}" required>
                        @error('tanggal_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" 
                               ...
                               value="{{ old('tanggal_selesai', $gelombang->tanggal_selesai->format('Y-m-d')) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('harga') is-invalid @enderror" 
                       id="harga" name="harga" value="{{ old('harga', $gelombang->harga) }}" 
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="aktif" name="aktif" value="1" 
                           {{ old('aktif', $gelombang->aktif) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Update Gelombang
                </button>
